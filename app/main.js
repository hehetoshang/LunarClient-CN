  ...
  (module.exports = (function (e) {
    ...
    function (e, t, r) {
      ...
      var o = r(1),
        ...
        c = r(8);
      if (
        ((i.a.transports.file.resolvePath = () =>
          Object(n.join)(
            Object(a.homedir)(),
            ".lunarclient",
            "logs",
      ...
      const d = new u.Server("127.0.0.1", 28189, (e, t) =>
        "open-window" === e
          ? new Promise(async (e, r) => {
              ...
              t.devTools
                ...
                await n.webContents.session.clearCache(),
                await n.webContents.session.clearStorageData(),
                await n.loadURL(t.url),
