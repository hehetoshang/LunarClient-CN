...
# Anti QiaoBoYuan
乔博远 微信qby140326 电话19921248973 qq2214646206 奶奶牛秀芝 mcuuid ea8ee3cc3e5f4298a4df7d3ec129cfd7开户乐子，多次恶俗，昵称多次改成cby真实姓名（包括暗示），劝解无效，私信骚扰cby，qq空间传播cby不实消息

和别人传播个人信息，已经影响到我，想和我和好却多次恶俗。
...
1. 去除封禁
2. 修复中文目录启动问题(未测试, 应该工作)
3. 修复空格路径问题导致的pythonw报错(未测试)
4. 修复[此问题](https://github.com/CubeWhyMC/LunarClient-CN/issues/5)(点击链接查看)

## v2.11.2-fix18

1. 增加自动检测LowIQ, 防止群内的平均IQ降低
...
1. 增加自动更新 (在代码中写了,但是bug多)
2. 修复JavaAgent参数拼接bug
